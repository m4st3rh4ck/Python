"""
Introducción
Trabajas en una empresa que vende coches de segunda mano. La dirección quiere obtener un resumen de las cantidades de vehículos que se han vendido al final de cada mes.
La empresa ya dispone de un servicio web que sirve los datos de ventas al final de cada mes, pero la dirección quiere que se envíe un correo electrónico con un PDF adjunto 
para que los datos sean más fácilmente legibles.
